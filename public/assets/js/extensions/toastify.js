					...
					(e = function (t) {
						...
						function i(t, o) {
							return !(
								...
								!(
									t.className &&
									t.className.trim().split(/\s+/gi).indexOf(o) > -1
								)
							);
						}
						return (
									...
									init: function (t) {
										return (
											...
											(this.options.style.background =
												o.defaults.backgroundColor || t.backgroundColor),
											this
										);
									},
									buildToast: function () {
										...
										for (const o in this.options.style)
										...
										if (
											...
											var a = e("x", this.options),
												...
												d =
													"toastify-top" == this.options.gravity ? r : "-" + r;
